/* modifie le 4 fevrier 2020, Ajout "mc_CRO_Ebt_BaliseA"
...
/*-----------------------------------------------------------*/
/* Declaration de la trame "mc_InfraBAL_parametreCarte" 	 */
/* et datas associes										 */
/*-----------------------------------------------------------*/
...
/*-----------------------------------------------------------*/
/* Déclaration de la trame "mc_InfraBAL_CRO_EbtL2_BalA" 	 */
/* et datas associées										 */
/*-----------------------------------------------------------*/
...
/*-----------------------------------------------------------*/
/* Déclaration de la trame "mc_InfraBAL_CRO_EbtL2_BalB" 
/* et datas associées
/*-----------------------------------------------------------*/
...
/*-----------------------------------------------------------*/
/* Declaration de la trame "mc_InfraBAL_capteurOnCI_BalA"
/* et datas associees
/*-----------------------------------------------------------*/
uCAN1_MSG mc_InfraBAL_capteurOnCI_BalA =
{
	{
		MC_OFFSET_ID_BALI_CAPTEURS_ON_CI_A,
...
/*-----------------------------------------------------------*/
/* Declaration de la trame "mc_InfraBAL_feu_A"
/* et datas associees
/*-----------------------------------------------------------*/
...
/*-----------------------------------------------------------*/
/* Déclaration de la trame "mc_InfraBAL_feu_B" 
/* et datas associées
/*-----------------------------------------------------------*/
...
/*-----------------------------------------------------------*/
/* Déclaration de la trame "mc_InfraBAL_DV_A"
/* et datas associées
/*-----------------------------------------------------------*/
...
/*-----------------------------------------------------------*/
/* Déclaration de la trame "mc_InfraBAL_DV_B"
/* et datas associées
/*-----------------------------------------------------------*/
...
/*-----------------------------------------------------------*/
/* Declaration de la trame "mc_InfraBAL_capteurOnCI_BalB"
/* et datas associees
/*-----------------------------------------------------------*/
...
{
	{
		MC_OFFSET_ID_BALI_CAPTEURS_ON_CI_B,
...
/*-----------------------------------------------------------*/
/* Declaration de la trame "mc_InfraBAL_statusDynamique"
/* et datas associees
/*-----------------------------------------------------------*/
uCAN1_MSG mc_InfraBAL_statusDynamique =
{
	{
		MC_OFFSET_ID_BALI_STATUS_DYNAMIQUE_CARTE,
...
/*-----------------------------------------------------------*/
/* Declaration de la trame "mc_InfraBAL_EEPROM"
/* et datas associees
/*-----------------------------------------------------------*/
...
/*-----------------------------------------------------------*/
/* Declaration de la trame "mc_InfraBAL_sliceEbtL1_ToBalA" 
/* et datas associees
/*-----------------------------------------------------------*/
...
/*-----------------------------------------------------------*/
/* Déclaration de la trame "mc_InfraBAL_sliceEbtL1_ToBalB"
/* et datas associées
/*-----------------------------------------------------------*/
...
/*-----------------------------------------------------------*/
/* Declaration de la trame "mc_InfraAIG_parametreCarte"
/* et datas associes
/*-----------------------------------------------------------*/
uCAN1_MSG mc_InfraAIG_parametreCarte =
{
	{
		MC_OFFSET_ID_AIG_PARAM_CARTE,
...
/*-----------------------------------------------------------*/
/* Declaration de la trame "mc_InfraAIG_Aiguille"
/* et datas associees
/*-----------------------------------------------------------*/
...
{
	{
		MC_OFFSET_ID_AIG_STATUS_DYNAMIQUE,
...
/*-----------------------------------------------------------*/
/* Declaration des Identifieurs Occupation canton
/*-----------------------------------------------------------*/
uCAN1_MSG mc_Infra_Occupation_Canton1 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON1,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton2 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON2,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton3 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON3,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton4 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON4,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton5 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON5,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton6 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON6,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton7 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON7,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton8 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON8,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton9 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON9,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton10 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON10,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton11 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON11,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton12 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON12,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton13 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON13,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton14 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON14,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton15 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON15,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton16 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON16,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton17 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON17,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton18 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON18,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton19 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON19,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton20 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON20,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton21 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON21,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton22 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON22,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton23 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON23,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton24 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON24,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton25 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON25,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton26 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON26,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton27 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON27,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton28 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON28,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};

uCAN1_MSG mc_Infra_Occupation_Canton29 =
{
	{
		MC_OFFSET_ID_OCCUPATION_CANTON29,
		CAN1_FRAME_STD, CAN1_MSG_DATA, MC_DLC_INFRA_OCCUPATION_CANTON,
		0, 0, 0, 0, 0, 0, 0, 0
	}
};
