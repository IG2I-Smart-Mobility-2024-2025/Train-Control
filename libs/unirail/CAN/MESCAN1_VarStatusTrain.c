...
// DÃ©claration de la trame "mc_MOT_statusStart" et datas associÃ©es
...
// DÃ©claration de la trame "mc_MOT_statusRun" et datas associÃ©es
...
MC_Bit bdmc_consigneSensDeplacementInterne = {
    MC_ID_MOT_STATUS_RUN,
    MOT_STATE_DYNAMIQUE,
    MOVE_SENS_LOCO_MANUEL_OR_REMOTE,
};

MC_Bit bdmc_modeStopLocoB4chgtSens = {
    MC_ID_MOT_STATUS_RUN,
    MOT_STATE_DYNAMIQUE,
    MODE_STOP_LOCO_B4_CHT_SENS,
};
...
// \todo Ã  valider
/*
Configuration Â«Â On BoardÂ Â» en cours de la locomotive
    bits[3..0] : Mode Â«Â ON boardÂ Â» en cours
